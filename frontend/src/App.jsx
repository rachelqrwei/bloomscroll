      ...
      <button
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm opacity-80 font-mono tracking-[-0.4px]">Generate a feed based on your inputted prompts!</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            <h3 className="font-bold text-lg ">Browse the library</h3>
            <p className="text-sm opacity-80 font-mono tracking-[-0.4px] ">Learn something new from our pre-generated topics!</p>
          </div>
        </button>
      </div>
